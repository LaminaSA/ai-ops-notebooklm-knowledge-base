...
My manager noticed my interest in AI and automation and informed me about a meeting centred around the use of AI-powered tools in our workplace. I was introduced to NotebookLM and immediately recognised its potential. This wasn’t just another tool — it was an opportunity to lift the weight of our product knowledge burden.

I pulled together all core documents across every product we sell and organised them into structured notebooks aligned with each business practice. I then expanded the scope to include promotion notebooks, ensuring proper governance so nothing sensitive or outdated made its way into the system.
The result was a conversational AI reference tool that acts as a single, reliable source of truth for product information.
___
## 🧰 3. Workflow & Tools
...
The main limitation is that NotebookLM relies on static PDFs. As products evolve, the knowledge risks becoming outdated. The logical next step is to automate ingestion so the notebooks refresh themselves with new releases and announcements, ensuring accuracy without the version-control nightmare.
